...
CREATE TABLE SpotifyClone.users_table(
    ...
    data_plan DATE NOT NULL,
    FOREIGN KEY (id_plan) REFERENCES SpotifyClone.plans_table(id_plan)
) ENGINE = InnoDB;

INSERT INTO SpotifyClone.users_table (user, age, id_plan, data_plan)
VALUES
...
CREATE TABLE SpotifyClone.album_table(
    ...
    FOREIGN KEY (id_artist) REFERENCES SpotifyClone.artists_table(id_artist)
) ENGINE = InnoDB;

INSERT INTO SpotifyClone.album_table (album, id_artist, launch_year)
VALUES
  ('Envious', 1, 1990),
  ('Exuberant', 1, 1993),
...
CREATE TABLE SpotifyClone.songs_table(
    ...
    FOREIGN KEY (id_album) REFERENCES SpotifyClone.album_table(id_album)
) ENGINE = InnoDB;

INSERT INTO SpotifyClone.songs_table (id_album, song, duration_seconds)
VALUES
  (1, "Soul For Us", 200),
...
CREATE TABLE SpotifyClone.follow_artists_table(
    ...
    FOREIGN KEY (id_user) REFERENCES SpotifyClone.users_table(id_user),
    FOREIGN KEY (id_artist) REFERENCES SpotifyClone.artists_table(id_artist)
) ENGINE = InnoDB;

INSERT INTO SpotifyClone.follow_artists_table (id_user, id_artist)
VALUES
  (1, 1),
  (1, 4),
  (1, 3),
...
CREATE TABLE SpotifyClone.history_table(
    ...
    FOREIGN KEY (id_user) REFERENCES SpotifyClone.users_table(id_user),
    FOREIGN KEY (id_song) REFERENCES SpotifyClone.songs_table(id_song),
    CONSTRAINT PRIMARY KEY(id_song, id_user)
) ENGINE = InnoDB;

INSERT INTO SpotifyClone.history_table (id_user, id_song, data_play)
VALUES
